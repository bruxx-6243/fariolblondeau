...
const data = {cover:
						new Proxy({"src":"/_astro/robbie-lens.V-YsoGVL.png","width":2120,"height":1139,"format":"png","fsPath":"C:/Users/blond/Documents/fariol-blondeau-resume/src/content/project/robbie-lens.png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "C:/Users/blond/Documents/fariol-blondeau-resume/src/content/project/robbie-lens.png";
							}
